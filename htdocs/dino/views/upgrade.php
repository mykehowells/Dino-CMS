...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content text-center" style="padding-bottom: 45px;">
            ...
            <h3 class="form-title"><?php echo __('global.good_news'); ?></h3>
			<p><?php echo __('global.new_version_available'); ?></p>
            
			<a href="<?php echo $url; ?>" class="btn default btn-outline"><?php echo __('global.download_now'); ?></a>
			<a href="<?php echo $base; ?>/admin" class="btn default btn-outline"><?php echo __('global.upgrade_later'); ?></a>
        </div>
