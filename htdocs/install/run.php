...
function current_timezone() {
	return Cookie::read('dino-install-timezone', 0) * 3600;
}
...
check('<code>content/</code> directory needs to be writable so we can upload your images and files.', function() {
...
check('Dino requires the php module <code>GD</code> to be installed.', function() {
