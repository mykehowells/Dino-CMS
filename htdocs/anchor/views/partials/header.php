                        ...
                        <ul class="nav navbar-nav">
                            <?php if(Auth::user()): ?>
								...
								<?php foreach($menu as $url): ?>
									<li class="menu-dropdown classic-menu-dropdown <?php if(strpos(Uri::current(), $url) !== false) echo 'active'; ?>">
                            ...
                            <li class="menu-dropdown classic-menu-dropdown active">
                                <a href="<?php echo Uri::to('admin/login'); ?>"><i class="icon-user"></i> Login</a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </div>
